...
const TIME_PREFS = ['Morning (7am–12pm)', 'Afternoon (12pm–5pm)', 'Evening (5pm–7pm)', 'As Soon As Possible'];
      ...
      <div className={styles.card}>
        ...
        <div className={styles.body}>
          <div className={styles.header}>
            ...
            <p className={styles.subtitle}>Fill in the fields below and we'll build a custom project estimate for you.</p>
          </div>
              ...
              <motion.form key="form" className={styles.form} onSubmit={handleSubmit} noValidate
                ...
                <motion.div className={styles.numberedField}
                  ...
                  <div className={styles.fieldInner}>
                    ...
                    <textarea id="v3-message" name="message" className={`${styles.input} ${styles.textarea}`}
                      placeholder="What are you looking to build or renovate? Square footage, scope, timeline?" rows={3}
                ...
                <button type="submit" disabled={isSubmitting} className={styles.submitBtn}>
                  {isSubmitting
                    ...
                    : <><FontAwesomeIcon icon={faPaperPlane} /><span>Submit Project Request</span></>}
                </button>
