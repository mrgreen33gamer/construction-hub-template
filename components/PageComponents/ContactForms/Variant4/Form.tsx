...
import {
  ...
  faHouseChimney, faHammer, faBath, faBuilding, faDraftingCompass, faClipboardList, faHardHat,
...
const SERVICES = [
  { icon: faHouseChimney,    label: 'New Home Construction', sub: 'Ground-up custom or spec build' },
  { icon: faHammer,          label: 'Additions & Remodels',  sub: 'Add space or update what you have' },
  { icon: faBath,            label: 'Kitchen & Bath',        sub: 'Full or partial renovation' },
  { icon: faBuilding,        label: 'Commercial',            sub: 'New build or tenant improvement' },
  { icon: faDraftingCompass, label: 'Design-Build',          sub: 'Design and construction, one contract' },
  { icon: faClipboardList,   label: 'General Contracting',   sub: 'Project management for your build' },
  { icon: faHardHat,         label: 'Other Project',         sub: 'Not sure yet — let\'s talk' },
];

const BUDGET_LABELS = ['Under $25,000', '$25,000–$75,000', '$75,000–$150,000', '$150,000–$300,000', '$300,000+'];
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A Bedrock project manager will reach out about your <strong>{selectedService}</strong> project.
                  </p>
                ...
                <motion.div key="step1" custom={dir} variants={slideVariants}
                  ...
                  <p className={styles.stepLabel}>What kind of project?</p>
                  ...
                  <div className={styles.budgetBlock}>
                    ...
                    <div className={styles.sliderEnds}>
                      <span>Under $25,000</span><span>$300,000+</span>
                    </div>
                  </div>
                ...
                <motion.div key="step2" custom={dir} variants={slideVariants}
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v4r-message">Describe Your Project</label>
                      <textarea id="v4r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" rows={3}
                        placeholder={`Tell us more about your ${selectedService.toLowerCase()} project.`}
                    ...
                    <button type="submit" disabled={isSubmitting} className={styles.nextBtn}>
                      {isSubmitting
                        ...
                        : <><span>Get My Free Estimate</span><FontAwesomeIcon icon={faArrowRight} /></>}
                    </button>
                  </form>
                </motion.div>
              )}
