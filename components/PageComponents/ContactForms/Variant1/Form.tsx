...
const TRUST_CHIPS = [
  ...
  { icon: faTag,          text: 'Written, itemized bid' },
  { icon: faShieldHalved, text: 'Licensed & Bonded' },
  { icon: faStar,         text: '4.8★ · 350+ reviews' },
];
      ...
      <div className={styles.inner}>
        ...
        <motion.div className={styles.header}
          ...
          <p className={styles.subtitle}>
            Tell us about your project and we'll have a project manager reach out — <strong>written bid, no pressure</strong>.
          </p>
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A Bedrock project manager will reach out shortly. Keep an eye on your inbox and phone.
                </p>
              ...
              <motion.div key="form" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.35 }}>
                ...
                <div className={styles.section}>
                  <p className={styles.sectionLabel}>What kind of project?</p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  <div className={styles.fieldsSection}>
                    ...
                    <div className={styles.field}>
                      <label className={styles.label} htmlFor="v1r-message">Describe Your Project</label>
                      <textarea id="v1r-message" className={`${styles.input} ${styles.textarea}`}
                        name="message" placeholder="What are you looking to build or renovate? What's your timeline?" rows={2}
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547208100"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 720-8100', section: 'ContactForm-V1' })}>
                          Call (254) 720-8100
                        </a>
                      </span>
                    </div>
