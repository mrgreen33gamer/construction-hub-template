...
const COVERAGES = [
  {
    ...
    detail: '$1,000,000 per occurrence / $2,000,000 aggregate',
  },
  {
    icon: faBuilding,
    title: 'Contractor Surety Bond',
    detail: 'Bonded for every project we take on',
  },
  {
    icon: faBriefcase,
    title: 'AGC Membership',
    detail: 'Associated General Contractors of America',
  },
  {
    icon: faFileContract,
    title: 'Workmanship Warranty',
    detail: '2-year warranty on every completed project',
  },
];
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <div className={styles.headerText}>
            ...
            <h2 className={styles.title}>We&apos;re Licensed &amp; Bonded</h2>
            <p className={styles.subtitle}>
              Every project we take on is backed by general liability insurance, a contractor
              surety bond, and our membership in the Associated General Contractors of America
              (AGC). You get peace of mind — and we get to build with integrity.
            </p>
          </div>
        </motion.div>
