...
const SERVICE_CTAS = [
  {
    ...
    headline: 'Ready to build your custom home?',
    body: 'Ground-up construction managed from foundation to final walkthrough. Written, itemized bid before we break ground.',
  ...
  },
  {
    key: 'kitchen-bath',
    icon: faBath,
    eyebrow: 'Kitchen & Bath Renovation',
    headline: 'Kitchen or bath overdue for an update?',
    body: 'Full gut renovations or targeted updates — plumbing, electrical, and finish carpentry under one contract.',
    cta: 'Start a Renovation',
    href: '/services/kitchen-bath-renovation',
  ...
  },
  {
    ...
    headline: 'Want design and construction under one roof?',
    body: 'One contract, one point of contact, one schedule — from concept through completion.',
  ...
  },
  {
    ...
    headline: 'Planning a commercial buildout?',
    body: 'New builds and tenant improvements managed to your business timeline, with a real itemized bid up front.',
