      ...
      <div className={styles.heroContainer}>
        ...
        >
          ...
          <h1 className={styles.heroTitle}>
            Central Texas Construction<br />
            <em>Done Right.</em><br />
            Every Time.
          </h1>
          <p className={styles.heroSubtitle}>
            Bedrock Construction Group has been building and renovating homes and businesses in{' '}
            <strong>{cityName}</strong> and across Central Texas for over a decade —
            with written bids, licensed and bonded crews, and a warranty on every single project.
          </p>
          ...
          <div className={styles.imageFrame}>
            <div className={styles.imageWrapper}>
              <Image
                ...
                alt="Bedrock Construction Group — Waco, Texas construction crew"
                fill
            ...
            <div className={styles.trustCard}>
              ...
              <div className={styles.trustCardText}>
                <span className={styles.trustCardTitle}>Bedrock Construction Group</span>
                <span className={styles.trustCardSub}>Waco's Most Trusted General Contractor</span>
              </div>
            </div>
          </div>
        </motion.div>
