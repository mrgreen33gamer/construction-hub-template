...
const BlogPreviewGrid: React.FC<BlogPreviewGridProps> = ({
  title       = 'Construction Tips & Insights',
  subtitle    = 'Practical advice for Central Texas homeowners and businesses — planning, permitting, and what to know before you build.',
  posts,
  count       = 4,
  viewAllLink = '/blogs',
