...
const logoName = 'Bedrock Construction Group';
const logoTagline = 'Licensed & Bonded General Contractor';
const navLinks = [
  { href: '/', label: 'Home' },
...
const phoneDisplay = '(254) 720-8100';
const phoneHref = 'tel:+12547208100';
