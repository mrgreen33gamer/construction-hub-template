...
const SITE_URL    = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.bedrockconstructiontx.com';
const BRAND_NAME  = process.env.NEXT_PUBLIC_BRAND_NAME ?? 'Bedrock Construction Group';
