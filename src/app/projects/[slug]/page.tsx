...
export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  ...
  return {
    title: `${project.title} | Bedrock Construction Group Case Study`,
    description: project.shortDesc,
    alternates: { canonical: url },
    openGraph: {
      title: `${project.title} | Bedrock Construction Group`,
      description: project.shortDesc,
      url, siteName: 'Bedrock Construction Group', locale: 'en_US', type: 'article',
