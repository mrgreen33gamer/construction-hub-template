    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>Bedrock Construction Group - Blog</h1>
          <p className={styles.pageSubtitle}>
            Real talk for Central Texas homeowners and businesses — hiring, permitting, remodeling, and building smart.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Planning a build or renovation in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We've been building and remodeling Waco-area homes and businesses as a licensed, bonded general contractor since 2012. Free on-site estimate, no obligation.
            </p>
